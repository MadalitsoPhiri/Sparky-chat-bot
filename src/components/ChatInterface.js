    ...
    return (
        <div className="w-full h-full flex flex-col justify-center items-center">
            ...
            <div className=" w-full p-3 flex flex-row gap-3">
                <input type="text" name="price" id="name" className="focus-ring-1 focus:ring-yellow-500 focus:border-yellow-500 block w-full px-3 p-2 sm:text-sm border-2  border-gray-300 rounded-full focus:outline-none shadow-sm"  type="text"></input>
                <button className="rounded-full p-2 bg-yellow-400 flex flex-row justify-center items-center"><svg class="w-6 h-6 transform rotate-90 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z"></path></svg></button>
            </div>
