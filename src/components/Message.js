...
export default function Message({msg}) {
    ...
    console.log(user)
    return (
       msg.sender != "client" ? <motion.div initial={{y:300}} animate={{y:0}} className="w-full flex flex-col items-start mb-5" >
           <div className="w-full mb-2 flex flex-row overflow-x-hidden items-end">
            ...
            <svg class="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clipRule="evenodd"></path></svg>
                </div> 
                <div className="flex flex-col flex-1 w-full">
                <p className="text-sm text-black flex-1 px-4 py-4 bg-[#e6e4e7] rounded-md  break-words max-w-[85%] mb-1">
     hhihirihri rojrogtjrogjrogr rjogjrogjrogrjgr rogjrogjrogjrojrg ogjrogjrogjrgr ojgrogjrgr
</p> 
<p className="text-[13px] font-light text-gray-700">Sparky • just now.</p> 
                </div>  
